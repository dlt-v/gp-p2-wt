...
while gra_dziala:
    ...
    # wyswietlenie wyniku
    tekst_z_wynikiem = moja_czcionka.render(
        f'Wynik: {Punkty}', False, (0, 0, 0))
    ekran.blit(tekst_z_wynikiem, (16, 16))
    # sprawdź czy koniec gry
    if waz.sprawdz_kolizje():
        tekst_z_przegrana = moja_czcionka.render(
            'Przegrana', False, (200, 0, 0))
        ekran.blit(tekst_z_przegrana,
                   (SZEROKOSC_EKRANU/2-50, WYSOKOSC_EKRANU/2))
        gra_dziala = False
